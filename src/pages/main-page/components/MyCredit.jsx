...
const MyCredit = ({ credit, open }) => {
  return (
    <div className='my-5 flex h-[8.5rem] w-full max-w-[120rem] flex-shrink-0 items-center justify-between rounded-xl border border-white bg-black px-5 py-10 sm:h-[13rem]'>
